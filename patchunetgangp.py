...
def run(args):
    ...
    trainer.build_optimizer('Adam', [
                            parameter for discriminator in model.discriminators for parameter in discriminator.parameters()], lr=args.discriminator_lr)
...
def main(argv):
    ...
    parser.add_argument('--save-directory', type=str,
                        default='../generation/patchunetgangp/', help='output directory')
